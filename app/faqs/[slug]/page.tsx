// Updated app/faqs/[slug]/page.tsx - Server component with embedded client components
...
export default async function FaqPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const safeSearchFAQs = (faq.searchFAQs || []).filter(searchFaq => 
    searchFaq && 
    searchFaq.slug && 
    searchFaq.slug.current && 
    searchFaq.question
  );
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
      ...
      <div className="pt-16 pb-8 px-4">
        <div className="container mx-auto text-center" style={{ maxWidth: '1600px' }}>
          ...
          {/* Search Box */}
          <div className="mb-6">
            <FAQPageSearch searchFAQs={safeSearchFAQs} />
          </div>
        </div>
      </div>
